define(["dojo/_base/declare",
        ...
        "dojo/_WidgetsInTemplatedMixin",
        "dojo/text!./templates/PointPicker.html"],

function(declare, lang, bootstrapMap, _ModelApiMixin, View, _TemplatedMixin, _WidgetsInTemplatedMixin, template) {
	
	return declare([View, _TemplatedMixin, _WidgetsInTemplatedMixin, _ModelApiMixin] , {
