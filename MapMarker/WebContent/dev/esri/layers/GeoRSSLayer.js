//>>built
define("esri/layers/GeoRSSLayer", ["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/json", "dojo/has", "../kernel", "../config", "../request", "./ServiceGeneratedFeatureCollection"], function(a, f, b, g, h, c, d, e) {
    return a([e], {
