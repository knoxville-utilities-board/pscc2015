//>>built
define("esri/layers/JoinDataSource", ["dojo/_base/declare", "dojo/_base/lang", "dojo/has", "../kernel", "../lang", "./DataSource", "./LayerMapSource", "./TableDataSource", "./QueryDataSource", "./RasterDataSource"], function(f, n, p, q, d, g, h, k, l, m) {
    var e = f(g, {
        ...
        _createLayerSource: function(a) {
            ...
            if ("mapLayer" ===
                ...
                switch (a.dataSource.type) {
                    case "table":
                        c = new k(a.dataSource);
                        break;
                    case "queryTable":
                        c = new l(a.dataSource);
                        break;
                    case "joinTable":
                        c = new e(a.dataSource);
                        break;
                    case "raster":
                        c = new m(a.dataSource);
                        break;
                    default:
                        c = a.dataSource
                }
        ...
        toJson: function() {
            var a = {
                    ...
                    rightTableSource: this.rightTableSource &&
                        this.rightTableSource.toJson(),
