//>>built
define("esri/layers/WMSLayer", ["require", "dojo/_base/kernel", "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/has", "../kernel", "../request", "../urlUtils", "../SpatialReference", "../geometry/Extent", "./DynamicMapServiceLayer", "./WMSLayerInfo", "dojo/query"], function(s, g, t, n, f, x, y, u, l, m, h, v, w) {
    return t([v], {
        ...
        _parseCapabilities: function(a) {
                ...
                if (b = this._getTag("Layer", a)) {
                    ...
                    if (c) {
                        ...
                        if (!this.allExtents || !this.allExtents.length) c.allExtents = [], f.forEach(this.layerInfos[0].allExtents, function(a,
                            b) {
                            a && (c.allExtents[b] = new h(a.toJson()))
                        }), this.allExtents = c.allExtents;
            ...
            } else this._errorHandler(Error("GetCapabilities request for " + this._getCapabilitiesURL + " failed. (Response is null.)"))
        },
        ...
        _getLayerInfo: function(a) {
            ...
            d && (e = new h(0, 0, 0, 0, new m({
                wkid: 4326
            })), e.xmin = parseFloat(this._getTagValue("westBoundLongitude", d, 0)), e.ymin = parseFloat(this._getTagValue("southBoundLatitude", d, 0)), e.xmax = parseFloat(this._getTagValue("eastBoundLongitude", d, 0)), e.ymax = parseFloat(this._getTagValue("northBoundLatitude",
                d, 0)), b.allExtents[0] = e);
            ...
            f.forEach(a.childNodes, function(a) {
                ...
                } else if (a.nodeName == g) a = (a.text ? a.text : a.textContent).split(" "),
        ...
        _useLatLong: function(a) {
            ...
            for (c = 0; c < this._REVERSED_LAT_LONG_RANGES.length; c++) {
                var d =
                    this._REVERSED_LAT_LONG_RANGES[c];
                if (a >= d[0] && a <= d[1]) {
                    b = !0;
                    break
                }
        ...
        _checkVisibleLayersList: function(a) {
            if (a && (0 < a.length && this.layerInfos && 0 < this.layerInfos.length) && "number" == typeof a[0]) {
                ...
                f.forEach(a, function(a) {
                    a <
                        this.layerInfos.length && b.push(this.layerInfos[a].name)
                }, this);
                a = b
            }
            return a
