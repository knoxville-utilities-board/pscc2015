//>>built
define("esri/arcgis/Portal", ["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/kernel", "dojo/_base/Deferred", "dojo/_base/array", "dojo/_base/sniff", "require", "../kernel", "../lang", "../request", "../Evented", "../IdentityManager"], function(h, c, w, l, g, B, t, x, y, z, A) {
    var f = {
            options: {
        ...
        e = {
            ...
            requestToTypedArray: function(a,
                b, d, f, g) {
                return k(e.request(a, b, d).then(c.partial(e.resultsToTypedArray, f, g)))
            },
            ...
            formatQueryParams: function(a, b, d) {
                ...
                a.q = !d && f.extraQuery ? "(" + a.q + ")" + f.extraQuery :
                    a.q;
                return a
            }
        },
        ...
        m = h([], {
            ...
            constructor: function(a) {
                c.mixin(this, a);
                this.folderId = this.ownerFolder ||
                    this.folderId;
            ...
            addComment: function(a) {
                ...
                return e.request(this.itemUrl + "/addComment",
                    b, {
                        usePost: !0
            ...
            _getIconUrl: function() {
                var a = this.type &&
                    ...
                    d = !1,
                    c = !1;
                0 < a.indexOf("service") || "feature collection" === a || "kml" === a || "wms" === a || "wmts" === a ? (d = -1 < g.indexOf(b, "Hosted Service"), a = "feature service" === a || "feature collection" === a || "kml" === a ? (c = -1 < g.indexOf(b, "Table")) ? "table" : d ? "featureshosted" : "features" : "map service" === a || "wms" === a || "wmts" === a ? d || -1 < g.indexOf(b, "Tiled") ? "maptiles" : "mapimages" : "scene service" === a ? "sceneweblayer" : "image service" === a ? -1 < g.indexOf(b, "Elevation 3D Layer") ? "elevationlayer" :
                        "imagery" : "stream service" === a ? "streamlayer" : "layers") : a = "web map" === a || "cityengine web scene" === a ? "maps" : "web scene" === a ? "webscene" : "web mapping application" === a || "mobile application" === a || "application" === a || "operation view" === a || "desktop application" === a ? "apps" : "map document" === a || "map package" === a || "published map" === a || "scene document" === a || "globe document" === a || "basemap package" === a || "mobile basemap package" === a || "mobile map package" === a || "project package" === a || "project template" === a || "pro map" ===
                    a || "layout" === a || "layer" === a && -1 < g.indexOf(b, "ArcGIS Pro") || "explorer map" === a && g.indexOf(b, "Explorer Document") ? "mapsgray" : "service definition" === a || "csv" === a || "shapefile" === a || "cad drawing" === a || "geojson" === a ? "datafiles" : "explorer add in" === a || "desktop add in" === a || "windows viewer add in" === a || "windows viewer configuration" === a ? "appsgray" : "rule package" === a || "file geodatabase" === a || "csv collection" === a || "kml collection" === a || "windows mobile package" === a || "map template" === a || "desktop application template" ===
                    a || "arcpad package" === a || "code sample" === a || "document link" === a || "tile package" === a || "operations dashboard add in" === a || "rules package" === a || "image" === a || "workflow manager package" === a || "desktop style" === a || "explorer map" === a && -1 < g.indexOf(b, "Explorer Mapping Application") || -1 < g.indexOf(b, "Document") ? "datafilesgray" : "geocoding service" === a || "network analysis service" === a || "geoprocessing service" === a || "geodata service" === a || "geometry service" === a || "geoprocessing package" === a || "locator package" === a ||
                    "geoprocessing sample" === a || "workflow manager service" === a ? "toolsgray" : "layer" === a || "layer package" === a || "explorer layer" === a ? "layersgray" : "task file" === a ? "taskfile" : "maps";
            ...
            _getPremiumIconUrl: function() {
                ...
                this.isPremiumContent &&
                    (b = -1 < g.indexOf(a, "Requires Credits") ? "premiumcredits" : "premiumitem");
        ...
        q = h([], {
            ...
            constructor: function(a) {
                ...
                this.created = this.created ? new Date(this.created) : null;
                this.banner = this.banner ? e.formatUrl(this.url + "/info/" +
                    this.banner) : "";
        ...
        Portal: h([A], {
            ...
            init: function(a, b) {
                ...
                return this._getSelf(this.portalUrl).then(c.hitch(this, function(a) {
                    f.self = c.mixin({}, a);
                    if ((a = a.user) && b) a.portal = this, a = new v(a), f.loggedInUser = c.mixin({}, c.mixin(a, {
                        credential: b
                    }));
