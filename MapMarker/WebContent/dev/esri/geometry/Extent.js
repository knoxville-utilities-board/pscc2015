//>>built
define("esri/geometry/Extent", ["dojo/_base/declare", "dojo/_base/array", "dojo/_base/lang", "dojo/has", "../kernel", "../lang", "../SpatialReference", "./Geometry", "./Point", "./webMercatorUtils", "./mathUtils"], function(w, u, p, A, B, x, s, y, m, t, z) {
    var v = {
            type: "extent",
            xmin: 0,
            ymin: 0,
