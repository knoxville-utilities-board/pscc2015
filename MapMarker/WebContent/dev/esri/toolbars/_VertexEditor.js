//>>built
define("esri/toolbars/_VertexEditor", ["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/connect", "dojo/_base/array", "dojo/has", "dijit/Menu", "dijit/MenuItem", "../kernel", "./_VertexMover", "../geometry/Point", "../geometry/jsonUtils", "dojo/i18n!../nls/jsapi"], function(r, s, k, p, w, t, u, x, m, n, q, v) {
    var l = r(null, {
        ...
        _addControllers: function() {
            this._firstMoveHandle =
                k.connect(m, "onFirstMove", this, this._firstMoveHandler);
            this._moveStopHandle = k.connect(m, "onMoveStop", this, this._moveStopHandler);
            ...
            this._canDel && (this._ctxMenu = new t({
                style: "font-size: 12px; margin-left: 5px; margin-top: 5px;"
            }), a = this._ctxDelete = new u({
                label: v.toolbars.edit.deleteLabel,
        ...
        _add: function(a, b, c) {
            var e, d, f = this.graphic,
                g = [];
            for (e = 0; e < a.length; e++) {
                var h = a[e],
                    k = [];
                for (d = 0; d < h.length; d++) k.push(new m(h[d], b, f, e, d, h.length, this, c));
                g.push(k)
            }
            return g
        },
        _remove: function(a) {
            a && p.forEach(a, function(a) {
        ...
        _isNew: function(a) {
            return -1 === p.indexOf(this._vertexMovers[a.segIndex], a) ? !0 : !1
        },
        ...
        _findMover: function(a) {
            ...
            p.forEach(this._vertexMovers, function(a) {
                c = c.concat(a)
            });
            b && p.forEach(b, function(a) {
                c = c.concat(a)
            });
        ...
        _moveStopHandler: function(a, b) {
            var c = this._isNew(a);
            !b || !b.dx && !b.dy ? !c && this._canAdd && this._showRelatedMidpoints(a) :
                (this._updateRelatedGraphic(a, a.relatedGraphic, a.graphic.geometry, a.segIndex, a.ptIndex, a.segLength, c), this._canAdd && (c ? this._addMidpoints(a) : (this._repositionRelatedMidpoints(a), this._showRelatedMidpoints(a))), this.toolbar._endOperation("VERTICES"))
        },
        ...
        _hideRelatedMidpoints: function(a) {
            var b = this._getAdjacentMidpoints(a.ptIndex,
                    a.segLength),
                c = this._mpVertexMovers[a.segIndex];
            for (a = 0; a < b.length; a++) c[b[a]].graphic.hide()
        },
        _repositionRelatedMidpoints: function(a) {
            var b, c = this._getAdjacentMidpoints(a.ptIndex, a.segLength),
                e = this._mpVertexMovers[a.segIndex];
            for (b = 0; b < c.length; b++) {
                var d = this._getAdjacentVertices(c[b], a.segLength),
                    f = a.relatedGraphic.geometry.getPoint(a.segIndex, d[0]),
        ...
        _addMidpoints: function(a) {
            ...
            e = new m(d, this._symbol2, this.graphic, a.segIndex, c, g, this, !0);
            a = new m(b, this._symbol2, this.graphic, a.segIndex, c + 1, g,
                this, !0);
            h.splice(c, 0, e, a)
        },
        _deleteVertex: function(a) {
            var b, c = a.ptIndex,
                e = this._vertexMovers[a.segIndex];
    ...
    s.mixin(l, {
        create: function(a, b, c) {
            switch (a.geometry.type) {
                case "multipoint":
                    return new l.MultipointVertexEditor(a, b, c);
                case "polyline":
                    return new l.PolylineVertexEditor(a, b, c);
                case "polygon":
                    return new l.PolygonVertexEditor(a,
                        b, c)
            }
        }
    });
    l.MultipointVertexEditor = r(l, {
        declaredClass: "esri.toolbars._MultipointVertexEditor",
        minLength: 1,
        constructor: function() {
            this._moveStartHandle = k.connect(m, "onMoveStart", this, this._moveStartHandler);
            k.disconnect(this._firstMoveHandle)
        },
        destroy: function() {
        ...
        _moveStartHandler: function(a) {
            var b = a.ptIndex,
                c = a.segLength - 1,
                e = a.relatedGraphic.geometry.points;
            a = e.splice(b, 1);
            e.push(a[0]);
        ...
        _updateRelatedGraphic: function(a,
            b, c, e, d, f, g, h) {
            a = b.geometry;
    ...
    l.PolylineVertexEditor = r(l, {
        ...
        _getControlPoints: function(a, b, c, e, d) {
            var f = this.map,
                g, h;
            this._isNew(a) ? (a = e, e += 1, 0 <= a && (g = f.toScreen(b.getPoint(c, a))), e <= d && (h = f.toScreen(b.getPoint(c, e)))) : (a = e - 1, e += 1, 0 <= a && (g = f.toScreen(b.getPoint(c, a))), e < d && (h = f.toScreen(b.getPoint(c, e))));
            return [g, h]
        },
        ...
        _getAdjacentVertices: function(a,
            b) {
            return [a, a + 1]
        },
        _deleteMidpoints: function(a) {
            ...
            if (1 === e.length) b.splice(f, 1)[0].destroy();
            else {
                g = this._getAdjacentVertices(f, c);
                d = a.relatedGraphic.geometry.getPoint(a.segIndex, g[0]);
                ...
                a = new m(d, this._symbol2, this.graphic, a.segIndex, f, c, this, !0);
        ...
        _updateRelatedGraphic: function(a, b, c, e, d, f, g, h) {
            a = b.geometry;
            g ? a.insertPoint(e, d + 1, q.fromJson(c.toJson())) : h ? a.removePoint(e, d) : a.setPoint(e, d, q.fromJson(c.toJson()));
            b.setGeometry(a)
        }
    });
    l.PolygonVertexEditor = r(l, {
        ...
        _getSegments: function(a) {
            ...
            for (b = 0; b < e.length; b++) {
                var f = e[b],
                    g = [];
                for (c = 0; c <
                    f.length - 1; c++) g.push(a.getPoint(b, c));
                d.push(g)
            }
            return d
        },
        ...
        _deleteMidpoints: function(a) {
            var b = a.ptIndex,
                c = this._mpVertexMovers[a.segIndex],
                e = c.length - 1,
                d = this._getAdjacentMidpoints(b, a.segLength).sort(),
                f, g;
            g = d[0];
            var h = d[d.length - 1];
            if (0 === b) {
                ...
                a = new m(b, this._symbol2, this.graphic, a.segIndex, e - 1, e, this, !0);
                ...
                a = new m(b, this._symbol2, this.graphic, a.segIndex,
                    g, e, this, !0);
        ...
        _updateRelatedGraphic: function(a, b, c, e, d, f, g, h) {
            a = b.geometry;
            g ? a.insertPoint(e, d + 1, q.fromJson(c.toJson())) : h ? (a.removePoint(e, d), 0 === d && a.setPoint(e, f - 1, q.fromJson(a.getPoint(e, 0).toJson()))) : (a.setPoint(e, d, q.fromJson(c.toJson())), 0 === d && a.setPoint(e, f, q.fromJson(c.toJson())));
            b.setGeometry(a)
        }
    });
    return l
