//>>built
define("esri/tasks/ClosestFacilityTask", ["dojo/_base/declare", "dojo/_base/lang", "dojo/has", "../kernel", "../request", "../geometry/normalizeUtils", "./Task", "./ClosestFacilitySolveResult"], function(b, h, p, q, k, l, m, n) {
    b = b(m, {
        ...
        __msigns: [{
            ...
            a: [{
                i: 0,
                p: ["incidents.features", "facilities.features", "pointBarriers.features",
                    "polylineBarriers.features", "polygonBarriers.features"
                ]
            }],
            e: 2
        }],
