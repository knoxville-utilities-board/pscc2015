//>>built
define("esri/tasks/ClosestFacilityParameters", ["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/json", "dojo/has", "../kernel", "../lang", "../graphicsUtils", "./NATypes"], function(f, k, c, l, m, g, e, h) {
    return f(null, {
        ...
        toJson: function(d) {
            ...
            if (this.directionsOutputType) switch (this.directionsOutputType.toLowerCase()) {
                case "complete":
                    b.directionsOutputType = "esriDOTComplete";
                    break;
                case "complete-no-events":
                    b.directionsOutputType = "esriDOTCompleteNoEvents";
                    break;
                case "instructions-only":
                    b.directionsOutputType =
                        "esriDOTInstructionsOnly";
                    break;
                case "standard":
                    b.directionsOutputType = "esriDOTStandard";
                    break;
                case "summary-only":
                    b.directionsOutputType = "esriDOTSummaryOnly";
                    break;
                default:
                    b.directionsOutputType = this.directionsOutputType
            }
            if (this.timeOfDayUsage) {
                var a;
                switch (this.timeOfDayUsage.toLowerCase()) {
                    case "start":
                        a = "esriNATimeOfDayUseAsStartTime";
                        break;
                    case "end":
                        a = "esriNATimeOfDayUseAsEndTime";
                        break;
                    default:
                        a = this.timeOfDayUsage
                }
                b.timeOfDayUsage = a
            }
            a = this.incidents;
            "esri.tasks.FeatureSet" === a.declaredClass &&
                0 < a.features.length ? b.incidents = c.toJson({
                    type: "features",
                    features: e._encodeGraphics(a.features, d && d["incidents.features"]),
                    doNotLocateOnRestrictedElements: this.doNotLocateOnRestrictedElements
                }) : "esri.tasks.DataLayer" === a.declaredClass ? b.incidents = a : "esri.tasks.DataFile" === a.declaredClass && (b.incidents = c.toJson({
                    type: "features",
                    url: a.url,
                    doNotLocateOnRestrictedElements: this.doNotLocateOnRestrictedElements
                }));
            a = this.facilities;
            "esri.tasks.FeatureSet" === a.declaredClass && 0 < a.features.length ? b.facilities =
                c.toJson({
                    type: "features",
