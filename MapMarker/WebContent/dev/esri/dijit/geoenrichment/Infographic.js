//>>built
define("esri/dijit/geoenrichment/Infographic", ["require", "module", "../../declare", "dojo/_base/lang", "dojo/dom-construct", "dojo/Deferred", "../_EventedWidget", "./DataProvider", "./Geoenrichment", "./config", "dojo/on", "../../tasks/geoenrichment/GeoenrichmentTask", "../../tasks/geoenrichment/RingBuffer", "dojo/dom-class", "./_Invoke", "./utils"], function(d, k, h, c, l, m, n, p, q, f, r, s, t, g, u, v) {
    function w(a, b) {
        var e = new m,
            c = new s(f.server);
        c.token = f.token;
