require({cache:{
'url:esri/dijit/geoenrichment/templates/_WizardPage.html':"<div style=\"width: 100%; height: 100%;\">\n    <div data-dojo-type=\"esri/dijit/geoenrichment/Grid\" data-dojo-attach-point=\"layoutGrid\"  class=\"Grid\">\n        ${content}\n    </div>\n</div>"}});
//>>built
define("esri/dijit/geoenrichment/_WizardPage", ["../../declare", "dojo/string", "dojo/dom-class", "dojox/mvc/Templated", "dojo/text!./templates/_WizardPage.html", "./Grid"], function(h, k, g, l, m, b) {
    var f = {
        busy: "Wizard_Loading",
        done: "Wizard_Done",
        error: "Wizard_Error"
