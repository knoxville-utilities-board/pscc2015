//>>built
define("esri/dijit/GeocodeMatch", ["require", "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/Deferred", "dojo/_base/array", "dojo/dom-construct", "dojo/dom-style", "dojo/Evented", "dojo/on", "dojo/uacss", "dijit/_WidgetBase", "dijit/Menu", "dijit/MenuItem", "dgrid/OnDemandGrid", "dgrid/Selection", "dgrid/Keyboard", "dgrid/extensions/DijitRegistry", "dgrid/extensions/ColumnResizer", "dgrid/extensions/ColumnHider", "dojo/store/Memory", "../kernel", "../graphic", "../InfoTemplate", "../SpatialReference", "../geometry/webMercatorUtils", "../geometry/Extent", "../geometry/Point", "../layers/GraphicsLayer", "../symbols/PictureMarkerSymbol", "../tasks/locator", "../tasks/AddressCandidate", "dijit/layout/BorderContainer", "dijit/layout/ContentPane", "dojo/i18n!../nls/jsapi", "./GeocodeMatch/Popup"], function(z, p, d, A, k, l, q, B, m, P, C, D, v, E, F, G, H, I, J, r, Q, n, K, R, w, x, L, M, s, t, u, N, y, e, O) {
    return p([C, B], {
